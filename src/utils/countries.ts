export const COUNTRIES = [
  ...
  { flag: '🇦ﺩ', code: '+376', name: 'Andorra' },
  { flag: '🇦🇴', code: '+244', name: 'Angola' },
  { flag: '🇦🇮', code: '+1', name: 'Anguilla' },
  { flag: '🇦🇶', code: '+672', name: 'Antarctica' },
